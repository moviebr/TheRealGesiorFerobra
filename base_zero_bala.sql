...
CREATE TABLE `players` (
  ...
  `madphp_signature` tinyint(4) NOT NULL DEFAULT '1' COMMENT 'Absolute Mango Â© MadPHP.org',
  `madphp_signature_bg` varchar(50) NOT NULL COMMENT 'Absolute Mango Â© MadPHP.org',
  `madphp_signature_eqs` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'Absolute Mango Â© MadPHP.org',
  `madphp_signature_bars` tinyint(4) NOT NULL DEFAULT '1' COMMENT 'Absolute Mango Â© MadPHP.org',
  `madphp_signature_cache` int(11) NOT NULL COMMENT 'Absolute Mango Â© MadPHP.org',
